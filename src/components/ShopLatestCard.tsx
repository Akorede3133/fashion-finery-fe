...
const ShopLatestCard = ({ latest, index }) => {
  return (
    <li className={`${(index === 2 || index === 3) && 'hidden'} sm:block`}>
      ...
      <div className=' text-center font-plus-jakarta py-1'>
        <h3 className='text-[1.125rem] sm:text-xl font-normal capitalize'>{latest.name}</h3>
        <p className='space-x-3'>
          <span className=' line-through text-neutral-gray-9 text-sm sm:text-base'>$363.00</span>
