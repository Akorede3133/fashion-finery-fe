...
const BestSeller = () => {
  return (
    <div className=' bg-tint-5 my-10'>
      <div className='w-[90%] mx-auto'>
        <h3 className=" text-2xl font-plus-jakarta py-6">
          Best seller <br />
          product
        </h3>
        <div className='flex gri grid-cols-3 sm:grid-cols- items-center gap-4 sm:gap-6 w-full'>
          <div className=' hidden sm:block h-[295px] w-ful sm:w-auto  sm:h-[650px] rounded-md'>
            <img src={womenBestSellerImg1} alt="Best seller product" className='object-cover h-[200px] sm:h-[600px] w-full rounded-lg' />
          </div>
          <div className='h-[295px] w-full sm:w-auto  sm:h-[650px] rounded-md'>
            <img src={womenBestSellerImg2} alt="Best seller product" className='object-cover h-[200px] sm:h-[600px]  w-full rounded-lg' />
          </div>
          <div className='h-[295px] w-full sm:w-auto sm:h-[650px]'>
            <img src={womenBestSellerImg3} alt="Best seller product" className='object-cover h-[200px] sm:h-[600px] w-full rounded-lg' />
          </div>
          <div className='h-[295px] w-full sm:w-auto sm:h-[650px]'>
            <img src={womenBestSellerImg4} alt="Best seller product" className='h-[200px] sm:h-[600px] object-cover w-full rounded-lg' />
