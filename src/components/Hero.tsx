const Hero = () => {
  return (
    <div>
      <div className="sm:hidden h-[65vh] bg-[url('assets/women/women-hero.png')] bg-no-repeat bg-cover bg-center w-full relativ flex flex-col justify-end gap-4 items-center ">
