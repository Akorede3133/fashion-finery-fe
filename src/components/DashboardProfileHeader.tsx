...
const DashboardProfileHeader = () => {
  return (
    <>
      <div>
        <div className=' relative lg:hidden bg-tint-5 flex justify-center h-[80px]'>
        ...
        <p  className=' border-b lg:hidden border-neutral-gray-5 text-center pb-1 font-bold text-xl mt-8'>Maah</p>
     </div>
     <div className='hidden lg:grid grid-cols-[1fr_3fr] relative items-center'>
